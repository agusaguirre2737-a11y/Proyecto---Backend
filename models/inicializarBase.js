...
async function inicializarBase() {
  try {
    ...
    // Si no existe, Sincroniza los modelos y crea la base
    await sequelize.sync({ force: true }); // force: true elimina las tablas y las recrea
    ...
    console.log('Base de datos inicializada y datos de prueba creados exitosamente.');
  } catch (error) {
